...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Sparks-seeder\n"
...
static const string mainnet_seeds[] = {"explorer.sparkscoin.io", "seed1.sparkspay.io", "seed2.sparkspay.io", "seed3.sparkspay.io", "seed4.sparkspay.io", ""};
static const string testnet_seeds[] = {"test1.sparkspay.io", "test2.sparkspay.io", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("sparkspay.io", 8890), true);
  }
  do {
